...
<center>
			...
			<!-- <legend>Frequently Added Questions</legend>
				...
				<hr>
					<h4>WHEN WILL I GET MY ORDERS?</h4>
						<p style="text-indent:60px; line-height:32px;">We wil ship your product 2-3 days around Negros<br> Occidental and It will take 4-6 days Nationwide.</p>
				<hr>
  ...
  <div class="card" style="width:80%;">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
	  Yes, we ship the products via LBC and 2GO only.
      </div>
    </div>
  </div>
  <div class="card" style="width:80%;">
  ...
  <div class="card" style="width:80%;">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
	  We wil ship your product 2-3 days around Negros<br> Occidental and It will take 4-6 days Nationwide.
      </div>
    </div>
  </div>
  <div class="card" style="width:80%;">
