	...
	<div id="menu">
		<center>
			 <ul>
				...
				<li><a href="product1.php" id="product">Product</a></li>
				<li><a href="aboutus1.php" id="about">About Us</a></li>
				<li><a href="contactus1.php" id="contact">Contact Us</a></li>
				<li><a href="privacy1.php" id="privacy">Privacy Policy</a></li>
				<li><a href="faqs1.php" id="FAQs">FAQs</a></li>
			</ul>
		</center>
	</div>
		...
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/shoes5.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/shoes3.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/shoes4.jpg" class="carousel"></div>
			</div>
