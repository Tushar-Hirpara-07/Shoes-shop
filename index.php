...
<body>
	<div id="header">
		...
		<label> Online Shoes Store </label>
			<ul>
...
<div id="container">
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h1><legend style="font-size: 27px; ma">Feature Items</legend></h1></center>
			<br />
				...
				$query = $conn->query("SELECT *FROM product WHERE category='feature' ORDER BY product_id DESC") or die (mysqli_error());
					...
					while($fetch = $query->fetch_array())
						...
						if($qty <= 5){
							...
							echo "<a href='details.php?id=".$fetch['product_id']."'><button class='button button1' style='color:red'>Add Cart</button></a>";
							echo "<br />";
							echo "<br />";
							echo "</center>";
							echo "</div>";
